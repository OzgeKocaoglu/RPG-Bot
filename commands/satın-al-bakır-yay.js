    ...
    Data.findOne({
        userID: message.author.id
            ...
            if(data.drachma < 25){
                ...
                if(message.member.roles.cache.some(r => r.name === "Bakır Yay")) return message.channel.send("Aldığın oklar sana yetmedi mi? Kaybol gözümün önünden");
...
module.exports.help = {
    name: "satın-al-bakır-yay",
    aliases: ["bakıryay", "satın al"]
}